        ...
        <header>
          <div class="firstnav mt-4 pe-5 text-center">
            <nav>
              <ul class="nav-links">
                ...
                <li>
                  <a href="{{route('Index')}}" class="centermenu"><img src="pictures/logo.png" alt="" /></a>
                </li>
          ...
          <div class="secondnav">
            <nav class="navbar navbar-expand-xm navbar-dark p-md-3">
              <div class="container">
                <a class="navbar-brand" width="20%" class="centermenu" href="{{route('Index')}}"><img src="pictures/logo.png" width="40%" alt="" /></a>
      ...
      <div class="row knowusallcontent">
        <div class="col-md-6 col-sm-12 mb-3">
          ...
          <p class="knowuscontent">
            ...
            brands foraying into the emerging and challenging Indian Market. After being in business for over 30
            years.
            <br><br>
            We are well equipped to build brands taking them to new heights of success with our excellent
            business relationships, infrastructure, innovations, technological know-how, financial muscle and
