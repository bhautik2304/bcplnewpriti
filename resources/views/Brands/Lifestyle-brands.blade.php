    ...
    <section id="tabs">
      <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          ...
          <button class="nav-link active" id="nav-lifestyle-tab" data-bs-toggle="tab" data-bs-target="#nav-lifestyle" type="button" role="tab" aria-controls="nav-lifestyle" aria-selected="false">
            Lifestyle
          </button>
        </div>
      </nav>
