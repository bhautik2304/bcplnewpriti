    ...
    <section id="tabs">
      <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          ...
          <button class="nav-link active" id="nav-prestige-tab" data-bs-toggle="tab" data-bs-target="#nav-prestige" type="button" role="tab" aria-controls="nav-prestige" aria-selected="false">
            Prestige
          </button>
      ...
      <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade show active " id="nav-prestige" role="tabpanel" aria-labelledby="nav-prestige-tab">
          <div class="container mt-4 mb-4">
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <div class="card text-white brand-tab-img">
